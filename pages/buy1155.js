...
import Lazy1155 from '../artifacts/contracts/Lazy1155.sol/Lazy1155.json'
...
if (x == chainId ) {
  ...
  async function buyNft(nft) {
    ...
    let contract = new ethers.Contract(Lazyaddr1155, Lazy1155.abi, signer)
    ...
    const sig = nft.sig
     ...
     const transaction = await contract.redeem(addr,{tokenId ,minPrice ,uri,Amount}, sig,{
      value: price
    })
